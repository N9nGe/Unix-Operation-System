...
// No cap no shift
static char scancode_set_1[MAX_SCAN_SIZE] = { // 58
...
// With cap, no shift
static char scancode_set_2[MAX_SCAN_SIZE] = {
    '\0', '\0', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '\0', '\0',
...
// no cap, with shift
static char scancode_set_3[MAX_SCAN_SIZE] = {
...
// with cap, with shift
static char scancode_set_4[MAX_SCAN_SIZE] = {
    '\0', '\0', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '\0', '\0',
	 'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p', '{', '}', '\0', '\0', 'a', 's',
	 'd', 'f', 'g', 'h', 'j', 'k', 'l' , ':', '"', '~', '\0', '\\', 'z', 'x', 'c', 'v',
	 'b', 'n', 'm', '<', '>', '?', '\0', '*', '\0', ' ', '\0'
